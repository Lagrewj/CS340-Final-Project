...
<?php
if(!($stmt = $mysqli->prepare("SELECT winery.name, wine.year, wine.type FROM wine INNER JOIN winery ON wine.wid = winery.id WHERE wine.type = ?"))){
	echo "Prepare failed: "  . $stmt->errno . " " . $stmt->error;
}

if(!($stmt->bind_param("s",$_POST['filterWineByType']))){
